        ...
        <React.Fragment>
            {
                ...
                ?
                (
                <div className="overflow-hidden relative w-36 h-96 p-1 m-1 float-left inline-block cursor-pointer transition-all hover:text-red-500" onMouseEnter={() => {mouseEnterV()}} onMouseLeave={()=>{mouseLeaveV()}}>
